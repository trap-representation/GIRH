              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2">
                  <input 
                    ...
                    className="block w-full rounded-md bg-gray-100 border-2 p-1 border-gray-600 h-8 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black"
                    required
                  />
                </div>
              </div>
